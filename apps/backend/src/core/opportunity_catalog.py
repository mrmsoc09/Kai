...
_CATALOG: list[Opportunity] = [
    ...
    _o(
        id="hackerone:snapchat",
        name="Snapchat Bug Bounty",
        organization="Snap Inc.",
        platform="hackerone",
        access_type="public_bbp",
        program_url="https://hackerone.com/snapchat",
        scope_url="https://hackerone.com/snapchat#scope",
        scope_summary="*.snapchat.com, *.snap.com, Snapchat mobile apps",
        scope_domains=["*.snapchat.com", "*.snap.com", "accounts.snapchat.com",
                        "snapchat-iOS", "snapchat-android"],
        max_payout_usd=15_000,
        min_payout_usd=200,
        vdp_only=False,
        response_sla_days=30,
...
_CREDENTIAL_REQUIREMENTS: dict[str, list[CredentialRequirement]] = {
    ...
    "hackerone:snapchat": [
        _cr("signup", "Snapchat Account", "https://accounts.snapchat.com/accounts/signup",
            "Create a dedicated Snapchat account for testing in-scope user flows."),
        _cr("api_key", "Snap Kit Developer Credentials", "https://kit.snapchat.com/",
            "Optional for API and integration endpoint testing where program scope allows.", required=False),
    ],
    "hackerone:yahoo": [
