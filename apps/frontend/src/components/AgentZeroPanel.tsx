...
export default function AgentZeroPanel(){
  ...
  return <div className='widget'>
    ...
    <div style={{marginTop:8, fontSize:12, color:'var(--text-muted)'}}>All communications in/out traverse Kaison Composer HiL relay. Scope and governance policies enforced here.</div>
  </div>
}
