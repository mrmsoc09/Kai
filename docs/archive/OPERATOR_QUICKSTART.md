...
# optional HiL relay target (Kaison Composer A2A endpoint)
...
3) Workflows
- Wizard: Ask Kaison Composer to stage a recon plan. Messages are logged to Kaison Composer Comms.
...
- All outbound communication funnels via Kaison Composer (HiL). The relay can be down; messages are still audited and visible in the Comms panel.
