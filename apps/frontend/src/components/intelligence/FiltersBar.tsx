...
export default function FiltersBar({stage, onStage, chain, onChain}: Props){
  ...
  return <div className='intel-controls'>
    ...
    <div style={{display:'grid',gap:6}}>
      ...
      <select value={chain||''} onChange={e=> onChain((e.target.value||null) as any)} style={{background:'#0b0c0d',color:'#c9d1d9',border:'1px solid #202326',padding:'8px',borderRadius:6}}>
